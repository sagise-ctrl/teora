...
const faqs = [
  ...
  },
  {
    ...
    a: "Daftar di Teora, lalu buat project baru. Pilih jenis project (General atau Academic), isi detail, dan mulai dengan panduan AI.",
  },
  {
    q: "Apakah gratis?",
    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <section className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {[
            { icon: BookOpen, label: "Task Mentor", desc: "Kelola tugas akademik dengan panduan bertahap" },
